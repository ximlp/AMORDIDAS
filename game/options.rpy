...
## Básico ######################################################################
define config.mouse = { }
define config.mouse['default'] = [ ( "gui/handpointeruno.png", 5, 5) ]
define config.mouse['mainmenu'] = [ ( "gui/handpointeruno.png", 5, 5) ]
define config.mouse['gamemenu'] = [ ( "gui/handpointeruno.png", 5, 5) ]

## Animaciones de textbutton
transform button_scale_hover:
    on hover:
        easeout 0.1 zoom 1.2
        anchor (0.5,0.5)
    on idle:
...
define fade1 = Fade(2.0, 2.0, 1.5)  # Ajusta los tiempos como desees
define fade2 = Fade(1.0, 1.0, 0.5)
define fade3 = Fade(0.5, 0, 0.5)
...
define config.name = _("AMORDIDAS")
...
define config.end_game_transition = Dissolve(.9)
...
define config.save_directory = "AMORDIDAS-1743049035"
